...
class TrackByBusScreen extends StatefulWidget {
  const TrackByBusScreen({super.key});

  @override
  State<TrackByBusScreen> createState() => _TrackByBusState();
}

class _TrackByBusState extends State<TrackByBusScreen> {
  int _tab = 1;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Column(
        children: [
          GreenHeader(title: 'Track by Bus Number'),
          Expanded(
